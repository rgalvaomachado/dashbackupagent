...
CREATE TABLE `tutore` (
  ...
  `cod_disciplina` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `tutore` VALUES (1,'Romulo Galvao Machado','1');
...
-- Dump completed on 2023-02-07 14:39:38
